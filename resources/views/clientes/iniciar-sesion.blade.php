  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto min-h-screen lg:py-0">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form method="POST" action="{{ route('login.simple') }}" class="space-y-4 md:space-y-6"> @csrf
                  <div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Aún no tengo una cuenta? <a href="/clientes/crear-clientes" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Regístrate</a>
                  </p>
              </form>
          </div>
      </div>
