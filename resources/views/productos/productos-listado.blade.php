...
@section('contenido')
                ...
                <div
                    ...
                    <div class="flex-1 flex items-center space-x-2">
                        <h5>
                            ...
                            <span class="dark:text-white">{{ $TotalProductos }}</span>
                        </h5>
                    </div>
                    <div
                ...
                <div
                    ...
                    <div
                        ...
                        <button type="button" id="createProductButton" data-modal-target="createProductModal"
                            ...
                            class="flex items-center justify-center text-white bg-primary-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        ...
                        <tbody>
                            @foreach ($productos as $producto)
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <span
                                            class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ $producto->categoria->nombre }}</span>
                                    </td>
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center">
                                            {{ $producto->existencia }}
                                            @if ($producto->existencia >= 0 && $producto->existencia < 50)
                                                <div class="h-4 w-4 rounded-full inline-block mr-2 bg-red-700"></div>
                                            @elseif ($producto->existencia >= 50 && $producto->existencia <= 250)
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <button type="button"
                                                data-drawer-target="drawer-read-product-advanced-{{ $producto->id }}"
                                                data-drawer-show="drawer-read-product-advanced-{{ $producto->id }}"
                                                aria-controls="drawer-read-product-advanced-{{ $producto->id }}"
                                            ...
                                            <button type="button" data-modal-target="delete-modal-{{ $producto->id }}"
                                                data-modal-toggle="delete-modal-{{ $producto->id }}"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="existencia"
                                ...
                                (Stock)</label>
                            <input type="number" name="existencia" id="existencia" min="0"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
    ...
    @foreach ($productos as $producto)
        <form action="{{ route('productos.update', $producto->id) }}" method="POST enctype="multipart/form-data"
            ...
            <div class="grid gap-4 sm:grid-cols-3 sm:gap-6 ">
                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div><label for="category-{{ $producto->id }}"
                    ...
                    <div><label for="marca-{{ $producto->id }}"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Marca</label><select
        ...
        <div id="drawer-read-product-advanced-{{ $producto->id }}"
            ...
            tabindex="-1" aria-labelledby="drawer-label-{{ $producto->id }}" aria-hidden="true">
            <div>
                <h4 id="read-drawer-label-{{ $producto->id }}"
                    class="mb-1.5 leading-none text-xl font-semibold text-gray-900 dark:text-white">
                    {{ $producto->nombre }}</h4>
                <h5 class="mb-5 text-xl font-bold text-gray-900 dark:text-white">${{ $producto->precio }}</h5>
            </div>
            <button type="button" data-drawer-dismiss="drawer-read-product-advanced-{{ $producto->id }}"
                aria-controls="drawer-read-product-advanced-{{ $producto->id }}"
                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <dl class="sm:mb-5">
                ...
                <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $producto->descripcion }}</dd>
            </dl>
            <dl class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Estado del producto</dt>
