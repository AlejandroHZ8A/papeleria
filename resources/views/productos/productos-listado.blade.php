...
@section('contenido')
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <button type="button" data-drawer-target="drawer-read-product-advanced-{{ $producto->id }}"
    ...
    <form action="#" id="drawer-update-product-{{ $producto->id }}"
        ...
        <h5 id="drawer-label-{{ $producto->id }}"
            ...
            Product</h5>
        <button type="button" data-drawer-dismiss="drawer-update-product-{{ $producto->id }}" aria-controls="drawer-update-product-{{ $producto->id }}"
    ...
    <div id="drawer-read-product-advanced-{{ $producto->id }}"
        ...
        <div>
            <h4 id="read-drawer-label-{{ $producto->id }}" class="mb-1.5 leading-none text-xl font-semibold text-gray-900 dark:text-white">
                {{ $producto->nombre }}</h4>
